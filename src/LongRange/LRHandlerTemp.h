...
private:
  ...
  void InitBreakup(ParticleLayout_t& ref,int NumFunctions)
  {
    ...
    if(FirstTime)
    {
      ...
      app_log() << "  LRBreakup parameter Kc =" << kc << std::endl;
 ...
 * $Revision: 7189 $   $Date: 2016-10-20 17:49:08 -0600 (Thu, 20 Oct 2016) $
 * $Id: LRHandlerTemp.h 7189 2016-10-20 23:49:08Z j.k.rofling@gmail.com $
 ***************************************************************************/
