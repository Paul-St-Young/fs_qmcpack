    ...
    const GridBCond<real_type,BC2>& g2)
{
  ...
  Nx=gridX.Ng;
  dx=gridX.Delta;
  dxInv=gridX.OneOverDelta;
  gridY=g1;
  Ny=gridY.Ng;
  dy=gridY.Delta;
  dyInv=gridY.OneOverDelta;
  gridZ=g2;
  Nz=gridZ.Ng;
  dz=gridZ.Delta;
  dzInv=gridZ.OneOverDelta;
}
    ...
    bool pbcx, bool pbcy, bool pbcz, bool openend)
{
  ...
  gridX.init(Nx,xi,xf,pbcx);
  dx=gridX.Delta;
  dxInv=gridX.OneOverDelta;
  gridY.init(Ny,yi,yf,pbcy);
  dy=gridY.Delta;
  dyInv=gridY.OneOverDelta;
  gridZ.init(Nz,zi,zf,pbcz);
  dz=gridZ.Delta;
  dzInv=gridZ.OneOverDelta;
}
 ...
 * $Id: TricubicBsplineGrid.cpp 7138 2016-09-27 23:45:29Z abenali $
 ***************************************************************************/
